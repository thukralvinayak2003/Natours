...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    L.marker([loc.coordinates[1], loc.coordinates[0]]).addTo(map).bindPopup("<p>".concat(loc.description, "</p>"), {
      autoClose: false
    }).openPopup();
  });
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"../../utils/catchAsync.js":[function(require,module,exports) {
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var bookTour = (0, _catchAsync.default)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51NSPNeSFIoG9GF9fkCSXUT5lVEIYl8LDxM840urB90FLABZWLp5hXRO3s2sZB9ZiFUSc1ODLsCx8X4up4WIWBewa00vBw9GANj'); //1 Get checkout session from API
          _context.next = 4;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","../../utils/catchAsync":"../../utils/catchAsync.js"}],"signup.js":[function(require,module,exports) {
"use strict";
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; //we are select the tourId from tour template
